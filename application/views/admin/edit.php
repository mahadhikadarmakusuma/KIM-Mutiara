...
<?php $a = $dataEditPemerintahan->row(); ?>
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="form-group row">
                <div class="col-md-4">
                    <?= form_open_multipart("PostinganController/ubah_foto")?>
                        <div class=" form-group">
                            ...
                            <?php } ?>
                            <!-- <video src="<?= base_url("images/uploads/$a->gambar");?>" alt="<?= $a->nama ?>" width="200px"><br> -->
                ...
                <div class="col-md-8">
                    <?= form_open_multipart('PostinganController/editPemerintahan') ?>
                        <div class="form-group row">
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Isi Postingan</label>
                                <div class="col-sm-10">
