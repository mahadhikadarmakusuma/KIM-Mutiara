<div class="container-fluid"> 
    ...
    <p class="panel-subtitle">Prestasi</p>
    <?php
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel"> 
                ...
                <form action="<?= site_url('DashboardController/prestasi')?>" method="get">
                    <div class="col-sm-4">
        ...
        <div class="col">
            ...
            <!-- MODAL HAPUS DATA -->
            <?php foreach ($pagination as $bb => $ps) { ?>
