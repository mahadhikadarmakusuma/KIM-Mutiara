<div class="container-fluid"> 
    <form class="navbar-form navbar-right">
        <div class="input-group">
            <span class="input-group-btn"><a href="<?php echo site_url('DashboardController/input_tentang') ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus-square"></i> Posting Baru</button></a></span>
        </div>
    </form>
                        ...
                        foreach ($postingan as $dd => $ps) { ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= site_url('PostinganController/editTentang/' . $ps['id']) ?>"><span class="label label-info"><i class="lnr lnr-pencil"></i> EDIT</span></a>
                ...
                <div class="modal fade" id="dataHapus<?php echo $ps['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" method="post" action="<?php echo base_url() . 'index.php/PostinganController/dataHapusTentang' ?>">
