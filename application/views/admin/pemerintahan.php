<div class="container-fluid"> 
    <form class="navbar-form navbar-right">
        <div class="input-group">
            <span class="input-group-btn"><a href="<?php echo site_url('DashboardController/posting') ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus-square"></i> Posting Baru</button></a></span>
        </div>
    </form>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel"> 
                ...
                <form action="<?= site_url('DashboardController/pemerintahan')?>" method="get">
                    <div class="col-sm-4">
